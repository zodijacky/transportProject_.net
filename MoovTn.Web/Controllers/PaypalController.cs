...
namespace MoovTn.Web.Controllers
{
    ...
    public class PaypalController : Controller
    {
        ...
        {
            SubscriptionCard subs =   db.subscriptioncards.Find(id);
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(payerId))
                {
                    ...
                    var createdPayment = this.CreatePayment(apiContext, baseURI + "guid=" + guid,subs.id);
        ...
        private Payment CreatePayment(APIContext apiContext, string redirectUrl, int id)
        {
            ...
            {
                name = subs.lines.ToList().First().name.ToString(),
                currency = "USD",
                price = "2000",
                quantity = "1",
                sku = subs.id.ToString()
            });
            ...
            {
                currency = "USD",
                total = "2002", // Total must be equal to sum of shipping, tax and subtotal.
                details = details
            };
            ...
            transactionList.Add(new Transaction()
            {
                ...
                invoice_number = subs.id.ToString(),
                amount = amount,
                item_list = itemList
            });
